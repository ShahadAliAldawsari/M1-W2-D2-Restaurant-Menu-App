...
)
{
    companion object{
        var item_0 = MenuItem(0, "Caramel Macchiato", 4.99, "A rich espresso with vanilla-flavored milk and a caramel drizzle.",
            "coffee", URL("https://example.com/caramel-macchiato.jpg"), true, R.drawable.cutlery)
        ...
        var item_3 = MenuItem(3, "Grilled Chicken Caesar Salad", 8.99, "Fresh romaine lettuce, grilled chicken, parmesan cheese, and croutons tossed in Caesar dressing.",
        ...
        var item_4 = MenuItem(4, "Margherita Pizza", 10.99, "A classic Italian pizza with fresh tomatoes, mozzarella, basil, and olive oil.",
            "dinner", URL("https://example.com/margherita-pizza.jpg"), true, R.drawable.cutlery)
